    ...
    <div id="main" class="main">
        <div id="content" class="content">
           <div class="header-category row-20">
             ...
             <ul>
                <li><p>gia san pham</p></li>
                <li><a href=""><h1>duoi 1.000.000</h1></a></li>
                <li><a href=""><h1>1.000.000-2.000.000</h1></a></li>
                <li><a href=""><h1>2.000.000-3.000.000</h1></a></li>
                <li><a href=""><h1>tren 3.000.000</h1></a></li>
             </ul>
