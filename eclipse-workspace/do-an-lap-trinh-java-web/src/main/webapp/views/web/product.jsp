...
<%@ include file="/common/web/header.jsp" %>
            <div class="content-body box-mini row-80">
                <div class="collection-product">
                    <div class="collection-product-img row-50"><img src="./template/web/img/${ product.img}.jpg" alt="" ></div>
                  ...
                  <form action="gio-hang" method="POST" >
                    <div class="product-doc-header">
                            ...
                            <button type="submit" class=" product-btn-addcart ti-shopping-cart-full">them vao gio hang</button>
