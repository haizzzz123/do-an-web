...
public class cartDAO extends AbstractDAO<cartModel> implements ICartDAO{
	...
	public List<cartModel> selectProductOfCart(String idKhachHang) {
		String sql =  "SELECT cart.idCart,product.idSanPham,tenSanPham, giaSanPham, nhaSanXuat, img, idHang, cart.soLuong\r\n"
				+ "FROM product\r\n"
				+ "INNER JOIN cart\r\n"
	...
	public List<cartModel> selectProductOfCartbyidBill(String idBill) {
		String sql = "SELECT bill_product.idBill,product.idSanPham,product.tenSanPham, giaSanPham, nhaSanXuat, img, idHang, bill_product.soLuong\r\n"
				+ "				FROM product\r\n"
